...
function AuthPage() {
  ...
  const handleGoogleSignIn = () => {
    ...
    setError("");
    try {
      // Ambil URL Backend dari env atau default ke localhost:3001
      const apiUrl = process.env.NEXT_PUBLIC_API_URL || "http://localhost:3001";
      
      // Arahkan user ke endpoint Google Auth di backend Anda
      // window.location.href digunakan karena kita akan keluar dari aplikasi React sejenak
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="mt-4">
              ...
              <motion.button
                ...
                disabled={loading}
                className="w-full mt-4 bg-white border border-gray-300 text-gray-700 font-semibold py-3 px-4 rounded-lg hover:bg-gray-50 transition disabled:opacity-50 flex items-center justify-center gap-3"
              >
